	...
	\begin{table}[h]
		...
		{%
			\begin{tabular}{|l|l|}
				...
				((Cow)aurochs).writeName();              & fail: we cannot limit to subclass
				                                                                 \\ \hline
				aurochs.writeLatin();                    & output: "Bos primigenius"
				                                                                 \\ \hline
				aurochs.writeDescription();              & output: "Aurochs"     \\ \hline
				((Aurochs)material).writeName();         & fail: we cannot limit to subclass
				                                                                 \\ \hline
			\end{tabular}
		}
	\end{table}
