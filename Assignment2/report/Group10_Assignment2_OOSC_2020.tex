...
\begin{document}
	...
	\bigskip
  Note:
  about the git commid id,
  we are working as a group on a private repository of ours in Github, and we can make it public if requested. We keep it private for staying in line with RWTH academic conduct guidelines.\\
  
	\bigskip
  our Git repo URL (private): \url{https://github.com/ulfet/ObjOrientedSoftware-Assignments/} \\
  the last commit id for this assignment: \\
  \url{37441dca89781ea53273eff532fb426cd3197227} 
